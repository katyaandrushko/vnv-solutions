  ...
  const serviceData = [
    {
      ...
      features: [
        'Ви хочете презентувати власний інфо-продукт, послугу, книгу і т.д.',
        'У вас невелика кількість продуктів (до 8)',
        'Вам потрібне коротке портфоліо спеціаліста або сайт-візитка',
      ],
...

    {
      ...
      features: [
        ...
        'У вас є багато продуктів або послуг для представлення',
...

    {
      ...
      features: [
        'Ви хочете розпочати продаж товарів або послуг в онлайні',
        'Бажаєте великий вибір функцій для управління продажами',
    ...
    },
    {
      ...
      features: [
        'Ви хочете покращити роботу свого існуючого веб-сайту',
        'Потрібен аналіз інформаційної структури та функціональності',
    ...
    },
    {
      ...
      features: [
        'Ви хочете отримати індивідуальну консультацію в області веб-розробки та маркетингу',
        'Бажаєте вирішити конкретні проблеми або встановити стратегічні цілі',
        'Потрібен план дій та рекомендації від професіоналів',
      ],
    },
  ]
  const [activeSection, setActiveSection] = useState('landing')
